...
@section('content')
    ...
    <header class="masthead bg-primary text-white text-center">
        <div class="container">
            <img class="img-fluid mb-5 d-block mx-auto" src="{{ asset('img/logo badung.png') }}" alt="">
            <h1 class="text-uppercase mb-0">SIL Kabupaten Badung</h1>
            <hr class="star-light">
            <h2 class="font-weight-light mb-0">Sistem Pengelolaan Lingkungan Kabupaten Badung</h2>
        </div>
    </header>
    ...
    <section class="portfolio" id="portfolio">
        <div class="container">
            <h2 class="text-center text-uppercase text-secondary mb-0">Portal</h2>
